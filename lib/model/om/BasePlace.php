...
abstract class BasePlace extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->lat = ($row[$startcol + 3] !== null) ? (double) $row[$startcol + 3] : null;
			$this->lng = ($row[$startcol + 4] !== null) ? (double) $row[$startcol + 4] : null;
			...
			return $startcol + 7; // 7 = PlacePeer::NUM_COLUMNS - PlacePeer::NUM_LAZY_LOAD_COLUMNS).
