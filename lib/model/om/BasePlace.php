...
abstract class BasePlace extends BaseObject  implements Persistent {
	...
	public function setCategoryId($v)
	{
		...
		if ($this->category_id !== $v) {
			$this->category_id = $v;
			$this->modifiedColumns[] = PlacePeer::CATEGORY_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = PlacePeer::USER_ID;
		}
	...
	public function setLat($v)
	{
		...
		if ($this->lat !== $v) {
			$this->lat = $v;
			$this->modifiedColumns[] = PlacePeer::LAT;
		}
	...
	public function setLng($v)
	{
		...
		if ($this->lng !== $v) {
			$this->lng = $v;
			$this->modifiedColumns[] = PlacePeer::LNG;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->lat = ($row[$startcol + 4] !== null) ? (double) $row[$startcol + 4] : null;
			$this->lng = ($row[$startcol + 5] !== null) ? (double) $row[$startcol + 5] : null;
			...
			return $startcol + 8; // 8 = PlacePeer::NUM_COLUMNS - PlacePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PlacePeer::CATEGORY_ID)) $criteria->add(PlacePeer::CATEGORY_ID, $this->category_id);
		if ($this->isColumnModified(PlacePeer::USER_ID)) $criteria->add(PlacePeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(PlacePeer::NAME)) $criteria->add(PlacePeer::NAME, $this->name);
		if ($this->isColumnModified(PlacePeer::LAT)) $criteria->add(PlacePeer::LAT, $this->lat);
		if ($this->isColumnModified(PlacePeer::LNG)) $criteria->add(PlacePeer::LNG, $this->lng);
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUser->addPlaces($this);
			 */
		}
